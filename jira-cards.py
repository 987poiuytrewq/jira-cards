...
template_parser.add_argument('-n', '--number', help='number of blank cards to generate', type=int, default=3)
...
for subparser in [board_parser, issue_parser]:
    ...
    subparser.add_argument('-a', '--anonymous', help='authentication not required', action='store_true')
